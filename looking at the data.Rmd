...
traffic_2$weekday <- ordered(traffic_2$day, levels=c("Monday", "Tuesday", "Wednesday", "Thursday", 
...
ggplot(traffic_2, aes(x = day, y = traffic_volume, group = day)) +
  geom_boxplot()
...
plot(traffic_2$day, traffic_2$traffic_volume)
